...
<body>
    <div class="container">
        <form class="m-auto w-50 mt-2 mb-2" method="POST" enctype="multipart/form-data" action="acciones/insertar.php">
            <div class="mb-2">
                <label class="form-label">Hoja N° </label>
                <input class='form-control form-control-sm' type="number" name="nombreArchivo">
            </div>
            <div class="mb-2">
                <label class="form-label">Mes </label>
                <input class='form-control form-control-sm' type="text" name="mes">
            </div>
            <div class="mb-2">
                <label class="form-label">Año </label>
                <input class='form-control form-control-sm' type="numero" name="anio">
            </div>
        ...
        <table class="table table-sm table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class='btn btn-secondary' href="index15.php?id=<?php echo $id?>">Editar</a> <a class='btn btn-danger' href="acciones/eliminar.php?id=<?php echo $id?>">Eliminar</a></td>
                </tr>
                <?php 
                    }
                ?>
