...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0 bg-dark">BUSCAR</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <!--  <li class="breadcrumb-item"><a href="index1.php">Principal</a></li>
              <li class="breadcrumb-item active">Documento/Organismo</li>-->
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <footer class="main-footer">
    <strong>2022 <a href="http://vsna.byethost10.com/isfta/?!=1">Desarrolladores: ISFT. Angaco</a>.</strong>
